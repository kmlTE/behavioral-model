...
service SimpleSwitch {
  ...
  i32 set_egress_priority_queue_rate(1:i32 port_num, 2:i32 priority, 3:i64 rate_Bps);
  i32 set_egress_queue_rate(1:i32 port_num, 2:i64 rate_Bps);
  i32 set_all_egress_queue_rates(1:i64 rate_Bps);

  i32 set_egress_priority_queue_quantum(1:i32 port_num, 2:i32 priority, 3:i64 quantum);
